...
---@class _.lspconfig.settings.als.RangeFormatting
...
---@field rangeFormatting _.lspconfig.settings.als.RangeFormatting
...
---@class _.lspconfig.settings.jdtls.AspectjSupport
-- Specify whether to enable `io.freefair.aspectj` plugin in Gradle projects. Defaults to `false`.
---@field enabled boolean

---@class _.lspconfig.settings.jdtls.GroovySupport
...
---@class _.lspconfig.settings.jdtls.KotlinSupport
...
---@class _.lspconfig.settings.jdtls.ScalaSupport
...
---@field aspectjSupport _.lspconfig.settings.jdtls.AspectjSupport
---@field groovySupport _.lspconfig.settings.jdtls.GroovySupport
---@field java _.lspconfig.settings.jdtls.Java
...
---@class _.lspconfig.settings.julials.CellCodeLens
...
---@field cellCodeLens _.lspconfig.settings.julials.CellCodeLens
...
---@class _.lspconfig.settings.omnisharp.FileBasedApps
...
---@field fileBasedApps _.lspconfig.settings.omnisharp.FileBasedApps
...
---@class _.lspconfig.settings.rust_analyzer.GotoImplementations
...
---@class _.lspconfig.settings.rust_analyzer.MissingArguments
...
-- ```
---@field enable boolean
---@field missingArguments _.lspconfig.settings.rust_analyzer.MissingArguments
...
---@class _.lspconfig.settings.volar.Hover
...
---@field hover _.lspconfig.settings.volar.Hover
...
---@class _.lspconfig.settings.wgls_analyzer.Validation
...
---@class _.lspconfig.settings.wgls_analyzer.Naga
...
---@field validation _.lspconfig.settings.wgls_analyzer.Validation
...
---@field external _.lspconfig.settings.wgls_analyzer.External
